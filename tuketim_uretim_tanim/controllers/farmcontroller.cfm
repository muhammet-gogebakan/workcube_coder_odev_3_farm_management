...
<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'farm.tanim';	//burda fuseaction tekrar belirtiliyor ki doğru bir şekilde çalışsın
		WOStruct['#attributes.fuseaction#']['list']['filePath'] = '/V16/add_options/mgogebakan_w3/coder_odev_3_farm_management/tuketim_uretim_tanim/views/list.cfm';	 	 
		...
		WOStruct['#attributes.fuseaction#']['add']['fuseaction'] = 'farm.tanim&event=add';
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = '/V16/add_options/mgogebakan_w3/coder_odev_3_farm_management/tuketim_uretim_tanim/views/add.cfm';		//add ekran önyüz
		WOStruct['#attributes.fuseaction#']['add']['queryPath'] = '/V16/add_options/mgogebakan_w3/coder_odev_3_farm_management/tuketim_uretim_tanim/actions/add.cfm';	//add ekran işlevi
		WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = WOStruct['#attributes.fuseaction#']['default'];				//add next event

		if (isDefined("attributes.GRUP_ID")) {

		WOStruct['#attributes.fuseaction#']['upd'] = structNew(); //upd işlevi için WO struct yapısı ekleme
		WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
		WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'farm.tanim&event=upd';
		WOStruct['#attributes.fuseaction#']['upd']['filePath'] = '/V16/add_options/mgogebakan_w3/coder_odev_3_farm_management/tuketim_uretim_tanim/views/upd.cfm';		//upd ekran önyüz
		WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = '/V16/add_options/mgogebakan_w3/coder_odev_3_farm_management/tuketim_uretim_tanim/actions/upd.cfm';	//upd ekran işlevi
